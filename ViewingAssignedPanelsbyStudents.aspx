<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewingAssignedPanelsbyStudents.aspx.cs" Inherits="ViewingAssignedPanelsbyStudents" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Viewing Assigned Panels by Students Page</title>
    <style>
...
<body>
    ...
    <div class="welcome-message">
        Welcome to Viewing Assigned Panels by Students Page
    </div>
    <form id="form1" runat="server" class="container">
        <div class="left-column">
            ...
            <div class="form-group">
                <label for="projectName">Enter Project Name whose Panel you want to Review:</label>
