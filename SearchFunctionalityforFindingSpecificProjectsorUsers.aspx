<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchFunctionalityforFindingSpecificProjectsorUsers.aspx.cs" Inherits="SearchFunctionalityforFindingSpecificProjectsorUsers" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Search for Finding Specific Projects or Users Page</title>
    <style>
...
<body>
    ...
    <div class="welcome-message">
        Welcome to Search for Finding Specific Projects or Users Page
    </div>
    <form id="form1" runat="server" class="container">
        <div class="left-column">
            ...
            <div class="form-group">
                <label for="projectName">Enter Project Name you want to Search:</label>
                <input type="text" id="projectName" name="projectName" />
            </div>
        
                
            <div class="form-group">
                <label for="userSearch">Enter User you want to Search:</label>
