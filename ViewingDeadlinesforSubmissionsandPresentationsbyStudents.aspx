<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewingDeadlinesforSubmissionsandPresentationsbyStudents.aspx.cs" Inherits="ViewingDeadlinesforSubmissionsandPresentationsbyStudents" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Viewing Deadlines for Submissions and Presentations by Students Page</title>
    <style>
...
<body>
    ...
    <div class="welcome-message">
        Welcome to Viewing Deadlines for Submissions and Presentations by Students Page
    </div>
    <form id="form1" runat="server" class="container">
        <div class="left-column">
            ...
            <div class="form-group">
                <label for="projectName">Enter Project Name whose Deadline for Submissions and Presentation you want to Review:</label>
